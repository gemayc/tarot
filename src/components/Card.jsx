    ...
    return (
        <>
            <button
                ...
                className="relative w-15 md:w-40 aspect-[3/5] overflow-hidden shadow-lg shadow-black/40 ring-1 ring-emerald-900/40 hover:scale-105 transition-transform duration-200 focus:outline-none rounded-xl">
